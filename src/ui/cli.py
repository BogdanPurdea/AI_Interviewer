...
def main():
    console.print(Panel("[bold magenta]AI Research Interviewer[/bold magenta]\n[dim]Powered by Ollama[/dim]", subtitle="CLI Version 2.0 (Modular)"))
    ...
    try:
        ...
        while session.is_active:
             ...
             if not session.is_active and ai_response == "Interview Complete.":
                 break
